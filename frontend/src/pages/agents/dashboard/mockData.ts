import type { CronJob, ActivityEntry, EventSubscription } from "shared";

// Re-export shared types for convenience in dashboard components
export type { CronJob, ActivityEntry, EventSubscription };
...
// These represent which mcp-secure-proxy connections this agent monitors.
...
export const mockEventSubscriptions: EventSubscription[] = [
  { connectionAlias: "discord-bot", enabled: true },
  { connectionAlias: "github", enabled: true },
  { connectionAlias: "slack", enabled: true },
  { connectionAlias: "trello", enabled: false },
  { connectionAlias: "stripe", enabled: false },
];
...
export const mockActivity: ActivityEntry[] = [
  ...
  { id: "a2", type: "event", message: "Responded to Slack DM from @sarah", timestamp: ago(15) },
  { id: "a3", type: "event", message: 'Urgent message detected in Discord #alerts: "API latency spike"', timestamp: ago(45) },
  ...
  { id: "a6", type: "event", message: "Calendar briefing sent for \"Sprint Planning\" meeting", timestamp: ago(360) },
  ...
  { id: "a11", type: "event", message: "Trello card assigned: \"Migrate user auth to OAuth2\"", timestamp: ago(4320) },
