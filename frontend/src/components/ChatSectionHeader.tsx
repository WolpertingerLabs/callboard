/**
 * The header above a sidebar chat section.
 *
 ...
 * header pinned above a bordered block, while these sit *inside* the run of
 * rows and repeat down it, so they need to read as bands rather than as
