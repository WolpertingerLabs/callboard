...
export default function PermissionSettings({ permissions, onChange, title, provider }: PermissionSettingsProps) {
  ...
  return (
    ...
    >
      ...
      {/* pi ships eight built-in tools — read, bash, powershell, edit, write,
          grep, find, ls — and none of them reaches the network. Leaving the
          control looking functional would be a gate that governs nothing. */}
      {provider === "pi" && (
